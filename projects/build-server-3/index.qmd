...
After changing this, it works properly ☺. Running a test server, I can access it publicly. 

I saw another interesting thing: [caddy security module](https://authp.github.io/) ([github](https://github.com/greenpau/caddy-security)), which lets you integrate caddy with ldap or other forms of authentication. I will consider integrating them in, or using authentik's reverse proxy features. 
...
Investigating the error, it seems to be something about relevant file permissions, it is unable to create the necessary file. I need to do more research into how rootless podman, and the different userns modes, interact with volumes. 
