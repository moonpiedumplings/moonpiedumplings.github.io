...
I want to compile rathole myself, and I have something almost working:
...
RUN apk add git build-base openssl-dev musl-dev
...
Since alpine seems to not work consistently for this, I think I will do what [this person did](https://stackoverflow.com/a/66967770), and compile the staticly linked binary on a debian or ubuntu docker container instead. 
