...
* How were they made? Subject matter involvement? Occupational focus?
...
* Book recommendation, by someone named Martin Yate.
    * Start with the [resume book](https://www.amazon.com/Knock-Dead-Ultimate-Search-Guide/dp/150720535X)
...
Someone also transcribed it to a [google sheets](https://docs.google.com/spreadsheets/d/1vhISsHTQZBTtaCWB1iNbM0ScBfp8fTTu4vNM7AxC72s/htmlview#gid=0).

They also put the job board on [imgur](https://imgur.com/a/scale-job-boards-E0HgRZV).
...
There is also a really interesting set of challenges, the [bashcrawl challenges](https://pacifichackers.com/challenges#Level%201), which are used to teach linux.
...
Then I went to many of the booths, and got so much cool stuff. From [rackspace](https://www.rackspace.com/) I got a nice boogie baord. And then from [coder](https://coder.dev/) I got a hand skateboard and a fidget cube. 

Flox gave everybody 3d printed fidget keycap cases to press. WRCCDC/Coastline college gave people

And then the foldable fidget cube on the left, is from [PureStorage](https://www.purestorage.com/)
...
![](images/coloringbooks.jpg)

And of course, physical versions of the [SELinux coling book](https://developers.redhat.com/e-books/selinux-coloring-book) and the [Container Commandos](https://developers.redhat.com/e-books/container-commandos-coloring-book) coloring book. I've seen the former on the internet before, but not the latter, but it seems to be cool, and goes over Red Hat's OCI products.
