...
Rebooting the wsl instance will enable you to have the 
...
In an administrative powershell or cmd session, run (editing as appropriate): 
...
Do not run any of these commands with sudo. 

Install nix (tool used to manage our development environments, this method requires systemd)):
