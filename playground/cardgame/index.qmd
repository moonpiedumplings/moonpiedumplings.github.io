...
Ward/Hexprooft: X : X : this card can resist X spell effects, unless opponent pays X production points What's defensive
...
Equality: X: X times N this card gives oppenent up to X*N of of "actives" it generates, when it generates them. 

Goal: Allow for the creation of board wipe type effects. 

Sacrifice X : X You need to sacrifice cards with a base cost of X * N cards on the field when played. 
