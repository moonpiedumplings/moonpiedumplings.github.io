...
|------------------|------------------|------------------|------------------|
| Mana Generation (probably call it just Mana for short) | X : X \* N (\*N?) | N/A | Generates Mana for casting things |
