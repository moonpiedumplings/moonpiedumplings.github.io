...
```{=html}
<style>
  /* Define the columns for screen display */
  /*.column {
  }*/

  /* Define the columns for print media */
  @media print {
    .column {
      column-count: 2; /* Maintain the same number of columns as on screen */
      column-gap: 20px;
      break-inside: avoid; /* Prevent column breaks within elements */
    }
  }
</style>
```
...
-------------------     ----------------------------
1 MyAddress                        email<br>@example.com
