...
The [projects](projects.qmd) documents my progress in my personal projects. 

[Blog](blog.qmd) are my writings and ramblings.

[Playground](playground.qmd) is my shorter term experiments and testings.

[Guides](guides.qmd) are guides I've written to help other people. For example, I created the [duckdns guide](guides/duckdns/) because I was tired of helping people through that myself. 