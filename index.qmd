...
[Projects](projects/index.qmd) documents my progress in my personal projects. 

[Blog](blog/index.qmd) are my writings and personal experiences with my systems.
...
[Writeups](writeups/index.qmd) are the writeups (explanations of CTF's) I do.
...
* The fulltext website search that [quarto provides](https://www.nationalccdc.org)
* Dark theme. You can't switch off from light theme when javascript is blocked from running.
* The in browser python code blocks on the [interactve, in browser python article](./playground/interactive-python-tutorial/) require javascript/webassembly to run. 