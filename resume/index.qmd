...
Avid user of Linux and related technologies for 6 years, intimately familiar with them through personal projects and daily usage. See <a href="https://moonpiedumplings.github.io/">my blog</a>
...
<table>
  ...
  <tr>
    <td>
      <ul>
        <li>Automated many mundane linux tasks using ansible <a href="https://github.com/CSUN-CCDC/CCDC-2023/tree/main/linux/ansible/roles">. </li>
...
<table><td><tr>
Current personal projects can be found on <a href="https://moonpiedumplings.github.io/">my blog</a>, where I document my processes as go. I make it a point to pick challenges beyond my current ability. I do not always succeed, but I do always grow in the process.
</tr></td></table>
```
